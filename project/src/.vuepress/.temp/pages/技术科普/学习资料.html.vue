...
<h2 id="unlock-huggingface" tabindex="-1"><a class="header-anchor" href="#unlock-huggingface"><span><a href="https://github.com/datawhalechina/unlock-hf" target="_blank" rel="noopener noreferrer">Unlock-HuggingFace</a></span></a></h2>
...
<p>unlock-hf在线阅读链接</p>
<h2 id="llm-deploy" tabindex="-1"><a class="header-anchor" href="#llm-deploy"><span><a href="https://github.com/datawhalechina/llm-deploy" target="_blank" rel="noopener noreferrer">LLM-Deploy</a></span></a></h2>
<p>本教程主要侧重于模型/LLM推理和部署理论与实践，旨在成为你掌握LLM推理与部署艺术的伙伴，无论你是初涉此领域的新人，还是寻求深化专业技能的资深人士，都能在此找到通往成功部署大型语言模型的关键路径。</p>
<h2 id="self-llm" tabindex="-1"><a class="header-anchor" href="#self-llm"><span><a href="https://github.com/datawhalechina/self-llm" target="_blank" rel="noopener noreferrer">self-llm</a></span></a></h2>
...
<h2 id="llm-universe" tabindex="-1"><a class="header-anchor" href="#llm-universe"><span><a href="https://github.com/datawhalechina/llm-universe" target="_blank" rel="noopener noreferrer">llm-universe</a></span></a></h2>
<h3 id="项目简介-1" tabindex="-1"><a class="header-anchor" href="#项目简介-1"><span>项目简介</span></a></h3>
<p>本项目是一个面向小白开发者的大模型应用开发教程，旨在基于阿里云服务器，结合个人知识库助手项目，通过一个课程完成大模型开发的重点入门，主要内容包括：</p>
<h3 id="大模型简介-何为大模型、大模型特点是什么、langchain-是什么-如何开发一个-llm-应用-针对小白开发者的简单介绍" tabindex="-1"><a class="header-anchor" href="#大模型简介-何为大模型、大模型特点是什么、langchain-是什么-如何开发一个-llm-应用-针对小白开发者的简单介绍"><span>大模型简介，何为大模型、大模型特点是什么、LangChain 是什么，如何开发一个 LLM 应用，针对小白开发者的简单介绍；</span></a></h3>
...
<h2 id="tiny-universe" tabindex="-1"><a class="header-anchor" href="#tiny-universe"><span><a href="https://github.com/datawhalechina/tiny-universe" target="_blank" rel="noopener noreferrer">tiny-universe</a></span></a></h2>
...
<h2 id="llm-cookbook" tabindex="-1"><a class="header-anchor" href="#llm-cookbook"><span><a href="https://github.com/datawhalechina/llm-cookbook" target="_blank" rel="noopener noreferrer">llm-cookbook</a></span></a></h2>
<p>面向开发者的大模型手册 - LLM Cookbook</p>
<h3 id="项目简介-2" tabindex="-1"><a class="header-anchor" href="#项目简介-2"><span>项目简介</span></a></h3>
...
<h2 id="handy-ollama" tabindex="-1"><a class="header-anchor" href="#handy-ollama"><span><a href="https://github.com/datawhalechina/handy-ollama" target="_blank" rel="noopener noreferrer">handy-ollama</a></span></a></h2>
<h3 id="项目简介-3" tabindex="-1"><a class="header-anchor" href="#项目简介-3"><span>项目简介</span></a></h3>
...
<h2 id="so-large-lm" tabindex="-1"><a class="header-anchor" href="#so-large-lm"><span><a href="https://github.com/datawhalechina/so-large-lm" target="_blank" rel="noopener noreferrer">so-large-lm</a></span></a></h2>
<h3 id="项目简介-4" tabindex="-1"><a class="header-anchor" href="#项目简介-4"><span>项目简介</span></a></h3>
